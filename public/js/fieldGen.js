...
points.forEach(([x, y], i) => {
  ...
  if (i + 1 == 39 || i + 1 == 62 || i + 1 == 40 || i + 1 == 61) {
    d.className = "inDot";
  } else if (i + 1 == 51) {
    d.className = "greenDot";
  } else if (i + 1 == 52) {
    d.className = "blueDot";
  } else if (i + 1 == 49) {
    d.className = "redDot";
  } else if (i + 1 == 50) {
    d.className = "yellowDot";
  } else {
    d.className = "dot";
  }
  d.style.left = px + "px";
...
//HOMES
let nummerationIndex = 0;
for (let i = 0; i < 4; i++) {
  let colors = ["Red", "Blue", "Yellow", "Green"];
  nummerationIndex += 10;
  const home = document.createElement("div");
  home.setAttribute("id", "home" + colors[i]);
  home.className = "home";
  ...
  for (let j = 0; j < 4; j++) {
    ...
    switch(j){
      case 0:
        aktDot.style.gridArea = "homeTL";
        aktDot.dataset.pointId = nummerationIndex + 1;
        break;
      case 1:
        aktDot.style.gridArea = "homeTR";
        aktDot.dataset.pointId = nummerationIndex + 2;
        break;
      case 2:
        aktDot.style.gridArea = "homeBL";
        aktDot.dataset.pointId = nummerationIndex + 3;
        break;
      case 3:
        aktDot.style.gridArea = "homeBR";
