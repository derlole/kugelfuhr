...
class FlowControl {
    constructor(){
        ...
        this.state2.changeSubText('<button class="stepButton">Karte ablegen</button><button class="stepButton">Karte abwerfen</button>') //<button class="stepButton">Karte abwerfen</button>
